/**
 * Clinical Calculator: CKD-EPI 2021 Creatinine Equation for Estimated GFR
...
export const EgfrCalculator: React.FC = () => {
  ...
  const [result, setResult] = useState<EgfrCalculatorResult | null>(null);
  ...
  const calculate = (e: React.FormEvent) => {
    ...
    setResult({
      score: rawScore,
      riskCategory: cat,
      clinicalInterpretation: `Calculated clinical index indicates ${cat} risk profile based on validated Nephrology scoring criteria.`,
      recommendations: [
  ...
  return (
    <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm space-y-4">
      <div>
        <h3 className="text-base font-black text-slate-900">CKD-EPI 2021 Creatinine Equation for Estimated GFR</h3>
        <p className="text-xs text-slate-500">Specialty Domain: Nephrology</p>
      </div>
