/**
 * Clinical Calculator: Glasgow Coma Scale (GCS) Neurological Impairment Assessment
...
export interface GlasgowComaScaleResult {
  score: number;
...
export const GlasgowComaScale: React.FC = () => {
  ...
  const calculate = (e: React.FormEvent) => {
    ...
    setResult({
      score: rawScore,
      riskCategory: cat,
      clinicalInterpretation: `Calculated clinical index indicates ${cat} risk profile based on validated Neurology / Trauma scoring criteria.`,
      recommendations: [
  ...
  return (
    <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm space-y-4">
      <div>
        <h3 className="text-base font-black text-slate-900">Glasgow Coma Scale (GCS) Neurological Impairment Assessment</h3>
        <p className="text-xs text-slate-500">Specialty Domain: Neurology / Trauma</p>
      </div>
