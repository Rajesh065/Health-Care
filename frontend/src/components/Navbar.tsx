...
export const Navbar: React.FC<{
  ...
  return (
    <header className="bg-white border-b border-slate-200 sticky top-0 z-40 shadow-xs w-full">
      {/* Clean Single Horizontal Top Bar (CRM Style) */}
      <div className="w-full px-6 py-3 flex items-center justify-between gap-4">
        ...
        {/* Right: Search, Action Button, and Persona Selector */}
        <div className="flex items-center gap-3">
          ...
          {/* Clean User Profile & Role Switcher */}
          {isAuthenticated && currentUser ? (
            <div className="relative">
              <div
                onClick={() => setIsProfileOpen(!isProfileOpen)}
                className="flex items-center gap-2.5 pl-1 cursor-pointer hover:bg-slate-50 p-1 rounded-xl transition-all border border-transparent hover:border-slate-200"
              >
              ...
              {isProfileOpen && (
                <div className="absolute right-0 mt-2 w-80 bg-white border border-slate-200 rounded-2xl shadow-xl p-3.5 space-y-3 z-50 text-xs">
                  <div className="border-b border-slate-100 pb-2.5">
                    ...
                    <span className="text-[10px] font-bold text-emerald-800 bg-emerald-50 border border-emerald-200 px-2 py-0.5 rounded inline-block mt-1">
                      {currentUser.role}
                    </span>
                  </div>
