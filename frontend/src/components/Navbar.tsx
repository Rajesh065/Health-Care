...
export const Navbar: React.FC<{
  ...
  return (
    <header className="bg-white border-b border-slate-200 sticky top-0 z-40 shadow-xs w-full">
      {/* Top Direct Persona Switcher Banner */}
      <div className="bg-slate-900 text-slate-200 px-6 py-1.5 flex flex-wrap items-center justify-between gap-2 border-b border-slate-800 text-[11px]">
        <div className="flex items-center gap-2">
          <span className="font-mono text-emerald-400 font-bold uppercase tracking-wider flex items-center gap-1">
        ...
        <div className="flex flex-wrap items-center gap-1.5">
          {PRESET_HOSPITAL_USERS.map(user => {
            ...
            return (
              ...
              >
                ...
                <span className="text-[9px] opacity-75 font-mono">({user.name.split(',')[0].replace('Dr. ', '')})</span>
              </button>
            );
          })}
          ...
          <button
            onClick={logout}
            className="ml-2 px-2.5 py-1 rounded-lg bg-rose-950/60 hover:bg-rose-900 text-rose-300 border border-rose-800/40 text-[10px] font-bold flex items-center gap-1 cursor-pointer"
          >
            <LogOut className="w-3 h-3" />
            <span>All Logins Page</span>
          </button>
        </div>
      </div>
                ...
                <div className="absolute right-0 mt-2 w-80 bg-white border border-slate-200 rounded-2xl shadow-xl p-3 space-y-3 z-50 text-xs">
                  ...
                  <div className="border-t border-slate-100 pt-2 flex justify-between items-center">
                    ...
                    <button
                      ...
                      className="text-rose-700 hover:text-rose-800 font-bold text-[11px] flex items-center gap-1 cursor-pointer"
                    >
